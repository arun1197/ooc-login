            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="panel white-alpha-90">
                    ...
                    <div class="panel-body">
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="/delete" method="post">
                            ...
                            <div class="input-group center">
                                <span id="btn-login" style="border-left: 0px"><input type="submit" name="Confirm Delete" class="btn btn-success"></span>
                            </div>
                        </form>
                    </div>
                </div>
